import FilterDropdown from '../class/FilterDropdown.js';
    ...
    const search = (activeTags, recipes) => {
        ...
        // If no recipe match, display a message to the user that no recipe match with his search
        if (document.querySelectorAll('.recipes-container .recipe:not(.hidden)').length === 0) {
